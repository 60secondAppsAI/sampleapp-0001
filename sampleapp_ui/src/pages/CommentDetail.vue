					...
					<tr> 
						<td style="width: 100%;"></td>
				        	<td style="width: 150px;">
				      			<base-button class="btn btn-primary" @click="updateComment()">Save</base-button>
				        	</td>
				        	<td style="width: 150px;">
				        	<td style="width: 150px;">
								...
								<div id="app">
								  <div class="container">
												    <base-button class="btn btn-primary" @click="modal2Comments = true">Add</base-button>
								              <modal :show.sync="modal2Comments">
          ...
          <a-modal :footer="null" :visible="userPermissionDialog" :closable="false" class="centered-modal" v-if="userPermissionDialog">
            <div style="text-align: center; padding: 20px;">
              ...
              <button @click="handlePermissionDialogClose">OK</button>
										...
										<tr> 
					<td class="detail_view_column_2">Comment Id</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="CommentId" type="text" placeholder="Enter CommentId" v-model="commentDetails.commentId"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Content</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="Content" type="text" placeholder="Enter Content" v-model="commentDetails.content"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Created Date</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<datepicker v-model="commentDetails.createdDate"  placeholder="Select Date" ></datepicker>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Issue Id</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="IssueId" type="text" placeholder="Enter IssueId" v-model="commentDetails.issueId"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">User Id</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="UserId" type="text" placeholder="Enter UserId" v-model="commentDetails.userId"></input>
																		</div>
						</td>
														</tr>
...
export default {
  ...
  methods: {
    ...
    async updateComment() {
      ...
      const jsonData = JSON.stringify(this.commentDetails);
      const res = await CommentService.update(jsonData);
...
//        this.getAllComments();
    ...
    async getCommentDetails() {
      try {
			let response = await CommentService.get(this.commentId);
